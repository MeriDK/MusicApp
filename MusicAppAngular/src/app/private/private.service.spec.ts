...
describe('PrivateService', () => {
  ...
  const homeUrl = 'http://127.0.0.1:8000/playlist/?type=1';
  ...
  describe('#getPlaylists', () => {
    ...
    beforeEach(() => {
      expectedData = [
        { id: 1, user: 'MeriDK', type: '1', name: 'Hobo of Mitchelstown', description: 'Сингл • The O\'Reillys and the Paddyhats • 2020'},
        { id: 2, user: 'MeriDK', type: '1', name: 'Sign of the Fighter', description: 'Альбом • The O\'Reillys and the Paddyhats • 2017'}
      ] as PlaylistModel[];
    });
